...
function Service1() {
  return (
        <div className='flex flex-col items-center self-center px-4 py-10 w-full text-white text-center'>
            <h1 className='mb-6 font-bold text-3xl md:text-4xl'>Our Services</h1>
            <div className='flex sm:flex-row flex-col justify-center gap-6 w-full max-w-4xl'>
                <div className='bg-white shadow-lg p-6 rounded-lg w-full sm:w-1/3 text-black'>
